...
#define R__DICTIONARY_FILENAME dIafsdIcerndOchdIuserdIpdIplucadIrepositoriesdItoolsmIeasyanalysisdIroofitdIdicdIRooApollonios
...
#include "/afs/cern.ch/user/p/pluca/repositories/tools-easyanalysis/roofit/RooApollonios.cpp"
